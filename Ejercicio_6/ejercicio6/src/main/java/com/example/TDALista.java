...
public interface TDALista<T> {
     ...
     */
    TDALista<T> ordenarTotal(Comparator<T> comparator);
    TDALista<T> ordenarParcial(Comparator<T> comparator);
    ...
    TDALista<T> invertir();
    TDALista<T> concatenar(TDALista<T> otra);
    TDALista<T> intercalar(TDALista<T> otra);
}
